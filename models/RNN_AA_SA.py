from tensorflow.keras.layers import Input, Activation, Dense,Flatten, BatchNormalization, Add, Conv2D,GlobalAveragePooling1D
...
def build_lstm_sa_aa_model(params):
    ...
    reshape_inp = Reshape((ts,input_shape[0]*input_shape[2])) (reshape_inp)
